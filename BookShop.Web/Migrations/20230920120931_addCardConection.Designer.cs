...
{
    [DbContext(typeof(BookShopWebContext))]
    [Migration("20230920120931_addCardConection")]
    partial class addCardConection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Models.CartProductConnection", b =>
                {
                    b.HasOne("BookShop.Models.Cart", "Cart")
                        .WithMany("CartProductConnections")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookShop.Web.Areas.Identity.Data.BookShopWebUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookShop.Models.Cart", b =>
                {
                    b.Navigation("CartProductConnections");
                });
